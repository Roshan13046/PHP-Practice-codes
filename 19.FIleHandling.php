...
<body>
   <div class="container-fluid">
       ...
       file_put_contents("1.19.fileHandling.txt","\r this is a new content add to the file by erasing previous contents.") or die("Unable to put contents into the file");
       $fileContent = file("1.19.fileHandling.txt") or die("Unable to read file");
       var_dump($fileContent); 
       
       //FILE_APPEND in file 
       file_put_contents("1.19.fileHandling.txt","\r<br/>Append contents.",FILE_APPEND) or die("Unable to Append  contents into the file");
       $fileContent = file("1.19.fileHandling.txt") or die("Unable to read file");
       var_dump($fileContent); 
